    ...
    <>
      ...
      <div className='max-w-[1440px] mx-auto lg:px-9 md:px-6 sm:px-4 px-2.5'>
        ...
        <div className='border-s border-e border-b border-[#5D5D5D]'>
          <div className='grid lg:grid-cols-[20%_40%_40%] sm:grid-cols-[50%_50%] grid-cols-[100%] gap-0'>
            <div className='lg:hidden block border-b sm:border-e border-e-0  border-[#5D5D5D]'>
              <Image
                height={252}
                width={290}
                src={OurMission}
            ...
            <div className='lg:px-10 md:px-7 sm:px-5 px-3 lg:py-7 sm:py-6 py-5 border-b border-[#5D5D5D]'>
              <h2 className='text-[#F0F2F5] font-medium text-[16px] mb-4 uppercase'>
                Our Mission
              </h2>
            ...
            <div className='lg:px-10 md:px-7 sm:px-5 px-3 lg:py-7 sm:py-6 py-5 border border-t-0 md:border-s border-s-0 sm:border-e border-e-0 border-[#5D5D5D]'>
              ...
              <ul className='list-disc ml-5'>
                <li className='text-[#F0F2F5] font-light text-sm m-0'>
            ...
            <div className='lg:px-10 md:px-7 sm:px-5 px-3 lg:py-7 sm:py-6 py-5 border border-t-0 md:border-b-0 border-b md:border-s border-s-0 sm:border-e border-e-0 border-[#5D5D5D]'>
              <h2 className='text-[#F0F2F5] font-medium text-[16px] flex items-center gap-2 mb-4 uppercase'>
                <Image
                  src={BottomleftAngle}
                  width={12}
            ...
            <div className='lg:px-10 md:px-7 sm:px-5 px-3 lg:py-7 sm:py-6 py-5 border-0 border-[#5D5D5D]'>
              <h2 className='text-[#F0F2F5] font-medium text-[16px] flex items-center gap-2 mb-4 uppercase'>
                <Image
                  src={BottomleftAngle}
                  width={12}
      ...
      <div className="max-w-[1440px] mx-auto lg:px-9 md:px-6 sm:px-4 px-2.5 ">
        <div className=' border-e border-s border-[#5D5D5D]'>
          ...
          <div className='flex gap-0 flex-col md:flex-row border-t border-[#5D5D5D]'>
            <p className='lg:w-[45%] md:w-[60%] w-full text-[#F0F2F5] font-light text-sm m-0 lg:px-6 md:px-4 sm:px-3 px-2 lg:py-12 md:py-8 py-6 md:border-e border-e-0 border-[#5D5D5D]'>
