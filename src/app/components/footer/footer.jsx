...
const Footer = () => {
  ...
  return (
    <footer className={`border-t border-[#BBBFCA]`}>
      <div className="md:py-4 py-7 max-w-[1440px] mx-auto lg:px-9 md:px-6 sm:px-4 px-2.5 flex lg:flex-row flex-col md:gap-0.5 gap-6  items-center justify-between h-full ">
        <div>
          <Link href='/'>
            <Image
              src={Logo}
        ...
        <div className='flex items-start sm:flex-row flex-col lg:gap-20 md:gap-16 sm:gap-10 gap-6'>
          ...
          <div>
            <Link
              href=''
              className="font-normal text-sm text-[#F4F4F2]"
            >
              Terms of Service
            </Link>
            <p className="font-normal text-sm m-0 mt-3 text-[#F4F4F2]">
              Email: <a href="mailto:hello@aweh.ventures" target='_blank'>hello@aweh.ventures</a>
            </p>
          </div>
        </div>
        <div>
          <p className="font-normal text-sm m-0 mb-3 text-[#F4F4F2]">
            Location: coming soon...
          </p>
          <p className="font-normal text-sm m-0 text-[#F4F4F2]">
