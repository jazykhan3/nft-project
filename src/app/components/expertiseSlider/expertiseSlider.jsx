...
const MultiCardCarouselEpertise = ({ sectionTitle, customclass, path, navigation = false }) => { // Accept navigation prop
    ...
    return (
        <div className={`multiitems-slider-expertise relative border-s border-e ${pathname === '/v2' ? 'border-[#BBBFCA]' : 'border-[#5D5D5D]'}`}> {/* Add relative to position custom icons */}
            <div className='flex items-center justify-between lg:px-6 md:px-4 sm:px-3 px-2 lg:pt-12 md:pt-10 pt-9 lg:pb-7 md:pb-5 sm:pb-4 pb-3'>
                ...
                {navigation && ( // Conditionally render navigation buttons
                    <div className="custom-nav-buttons">
                        <div className={`swiper-button-prev-${customclass} w-[60px] h-[60px] border py-5 px-6 ${pathname === '/v2' ? 'border-[#BBBFCA]' : 'border-[#5D5D5D]'}`}>
                            <Image width={10} height={20} src={rightIcon} alt="Prev" className='rotate-180 w-[10px] h-[20px] object-contain ' />
                        </div>
                        <div className={`swiper-button-next-${customclass} next w-[60px] h-[60px] border py-5 px-6 ${pathname === '/v2' ? 'border-[#BBBFCA]' : 'border-[#5D5D5D]'}`}>
            ...
            >
                ...
                <SwiperSlide className="swiper-slide-item">
                    <div className={`sliding-item relative flex flex-col border border-s-0 py-6 px-7 ${pathname === '/v2' ? 'border-[#BBBFCA]' : 'border-[#5D5D5D]'}`}>
                        ...
                        <div className="">
                            ...
                            <p className={`text-sm font-light mb-2 ${pathname === '/v2' ? 'text-[#F4F4F2]' : 'text-[#F0F2F5]'}`}>
