...
const MultiCardCarouselEpertise = ({ sectionTitle, customclass, path, navigation = false }) => { // Accept navigation prop
    ...
    return (
        <div className="multiitems-slider-expertise relative border-s border-e border-[#5D5D5D]"> {/* Add relative to position custom icons */}
            ...
            >
                ...
                <SwiperSlide className="swiper-slide-item">
                    <div className="sliding-item relative flex flex-col border border-s-0 border-[#5D5D5D] py-6 px-7">
