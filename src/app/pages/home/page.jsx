      ...
      <div className='max-w-[1440px] mx-auto lg:px-9 md:px-6 sm:px-4 px-2.5'>
        <div className='border-s border-e border-b border-[#5D5D5D] lg:px-6 md:px-4 px-0 lg:py-8 md:py-7 py-6'>
          <div className='grid lg:grid-cols-4 md:grid-cols-3 grid-cols-2 lg:gap-4 md:gap-2 gap-0'>
            ...
            <div className='border border-[#5D5D5D] md:border-b border-b-0 md:border-e border-e-0 relative group'>
              <Image
                height={12}
                width={12}
                src={ToprightIcon}
              ...
              <Link
                href=''
                className='text-white font-normal text-sm flex gap-2.5 p-4 w-full group-hover:bg-[#336DFF] justify-center items-center uppercase group-hover:border-t-0 border-t border-[#5D5D5D]'
              >
                Website
              </Link>
            </div>
            <div className='border md:border-e border-e-0 border-[#5D5D5D] md:border-s border-s-0 relative group'>
              <Image
                height={12}
                width={12}
                src={ToprightIcon}
            ...
            <div className='border border-[#5D5D5D] md:border-e border-e-0 relative group'>
              <Image
                height={12}
                width={12}
                src={ToprightIcon}
            ...
            <div className='border md:border-t border-t-0 md:border-e border-e-0 md:border-s border-s-0 border-[#5D5D5D] relative group'>
              <Image
                height={12}
                width={12}
                src={ToprightIcon}
            ...
            <div className='border md:border-t border-t-0 border-[#5D5D5D] md:border-e border-e-0 relative group'>
              <Image
                height={12}
                width={12}
                src={ToprightIcon}
